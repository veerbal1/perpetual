...
## Current Position
- Ring: 7 of 26
- Active Concept: Ring 7 — Study Slice 2 CLOSED 2026-05-09. Next-step decision pending: (a) open Ring 8 (unblocks real fill orchestration), or (b) build standalone Ring 7 helpers (`PerpFulfillmentMethod` enum, `math/matching.rs::do_orders_cross`).
